...
def get_subarrays(subarray_pairs: list[tuple],
                  numbers: list[int]) -> list[list[int]]:
    return (filter_numbers_by_pair(subarray_pairs, numbers)
            + filter_numbers_by_digit(numbers))


def filter_numbers_by_pair(
        subarray_pairs: list[tuple], numbers: list[int]) -> list[list[int]]:
...
def filter_numbers_by_digit(numbers: list[int]) -> list[list[int]]:
    subsets = [list(filter(lambda x: x == number, numbers))
