...
class SherlockAndSquares(unittest.TestCase):
    ...
    def test_should_return_number_of_perfect_squares_in_given_range(
            self) -> None:
        ...
        # When
        actual = get_perfect_squares(
            FIRST_PERFECT_SQUARE, LOWER_BOUND, UPPER_BOUND)
    ...
    def test_should_retrieve_first_square_root_for_int_in_given_range(
            self) -> None:
    ...
    def test_should_evaluate_if_perfect_square_is_within_given_bound(
            self) -> None:
