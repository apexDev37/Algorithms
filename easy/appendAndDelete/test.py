...
class TestAppendAndDelete(unittest.TestCase):
    ...
    def test_should_return_yes_if_enough_moves_to_append_and_delete_matching_char_strings(self) -> None:
        """
        ...
        # When
        actual = append_by_matching_chars(initial_string, desired_string, moves)
    ...
    def test_should_return_true_if_strings_have_same_chars_sequence(self) -> None:
        """
    ...
    def test_should_return_yes_if_can_replace_substrings_to_attain_desired_strings(self) -> None:
        """
