...
class LibraryFine(unittest.TestCase):
  ...
  def test_should_check_if_book_is_returned_on_or_before_due_date(
          self) -> None:
  ...
  def test_should_charge_zero_fine_for_book_return_on_or_before_due_date(
          self) -> None:
  ...
  def test_should_compute_date_difference_between_the_return_and_due_date(
          self) -> None:
  ...
  def test_should_compute_fine_based_on_highest_difference_between_dates(
          self) -> None:
  ...
  def test_should_return_date_object_given_integer_values_representing_date(
          self) -> None:
